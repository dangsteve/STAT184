...
/* ---------- persistence ---------- */
function vSaveKey(){return 'cs2_vsave_'+G.mapId;}
function vBestKey(){return 'cs2_vbest_'+G.mapId;}
function vHasSave(mapId){try{return !!localStorage.getItem('cs2_vsave_'+mapId);}catch(e){return false;}}
function vBestWave(mapId){try{return +localStorage.getItem('cs2_vbest_'+mapId)||0;}catch(e){return 0;}}
function vSaveGame(){
  try{
...
function vLoadGame(mapId){
  try{
    const s=JSON.parse(localStorage.getItem('cs2_vsave_'+mapId));

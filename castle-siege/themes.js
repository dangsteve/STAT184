...
function applyTheme(id){
  ...
  try{localStorage.setItem('cs2_theme',CUR_THEME);}catch(err){}
...
function loadThemePref(){
  let id='castle';
  try{id=localStorage.getItem('cs2_theme')||((typeof DEFAULT_THEME!=='undefined')?DEFAULT_THEME:'castle');}catch(err){}
  applyTheme(id);
}
